...
The project domain layer: finds `.katalyst/`, loads schemas and bases, exposes
collections, resolves selectors, and enumerates concrete items for the CLI.
...
[Bases](../../docs/content/deep-dives/domain-model/storage.md) docs. This file keeps only
