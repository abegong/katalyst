...
Katalyst is a single binary with no service to stand up. Run it by hand, wire
it into a pre-commit hook, or gate writes in CI. Use only the infrastructure
that you need for your particular use case.
...
For more on these ideas, see [Deep dives]({{< relref "deep-dives/_index.md" >}}), especially [Vision and scope]({{< relref "deep-dives/why-katalyst/_index.md" >}}).
