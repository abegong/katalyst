...
1. **File:** `make docs-gen` — regenerate
   ...
   set.
2. **Files:** `docs/content/explanation/domain-model.md`,
   `docs/content/how-to/configure-rules.md`,
...
6. **File:** `cmd/check_test.go` (or equivalent) — assert: a single-item
...
2. **Files:** `docs/content/explanation/` — document the collection-scoped check
...
5. **File:** `product/specs/filesystem-checks-spec.md` — tick the Tier 3
   ...
   both shipments have landed (rationale graduates into the explanation page).
...
| `docs/content/explanation/*`, `how-to/configure-rules.md`, `reference/configuration.md`, `glossary.md`, `AGENTS.md` | Graduation targets (Phases 3, 5) |
